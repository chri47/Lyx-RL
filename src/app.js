...
// WELCOME CON BANNER + AVATAR + NOME - ORA FUNZIONA
client.on('guildMemberAdd', async (member) => {
    ...
    try {
        ...
        // 3. NOME UTENTE GROSSO CON BORDO
