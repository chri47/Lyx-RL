  ...
  .addSubcommand(subcommand =>
    ...
    async execute(interaction, client) {
        ...
        if (subcommand === 'setup') {
          ...
          .setColor(0x2b2d31)
          .setThumbnail('https://i.imgur.com/krazy-logo.png') // METTI QUI IL LOGO LYK - così sta a destra
          .setFooter({ text: 'LYK Services', iconURL: interaction.guild.iconURL() });
    ...
    async handleButton(interaction, client) {
        ...
        if (categories[interaction.customId]) {
          ...
          .setColor(0x57F287)
          .setThumbnail('https://i.imgur.com/krazy-logo.png') // LOGO LYK A DESTRA ANCHE QUI
